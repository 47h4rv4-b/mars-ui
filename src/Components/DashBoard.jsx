      ...
      <Container fluid>
                ...
                <Row >
                  ...
                  <Col xs="7" >
                    <div className="numbers">
                      <p className="card-category">IMU data</p>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Kinect</p>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">esp32</p>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">motor driver</p>
        ...
        <Row>
          <Col md="8">
            <Card>
              <Card.Header>
                <Card.Title as="h4">SLAM</Card.Title>
          ...
          <Col md="4">
            <Card>
              <Card.Header>
                <Card.Title as="h4">EKF</Card.Title>
